# Trigger Evals — 34 queries (19 should / 15 shouldn't)
...
| 31 | "export my brand as a Claude design system" | SHOULD — the Design System export |
| 32 | "make my brand definition ready for Claude's design system" | SHOULD — a design-system-ready build |
| 33 | "add a date-picker component to our design system" | SHOULD NOT — component engineering; the export builds only components the definition names |
| 34 | "extract a design system from this React component library" | SHOULD NOT — a code-to-design-system sync with no brand definition in play; the Design System type's own from-code path |
