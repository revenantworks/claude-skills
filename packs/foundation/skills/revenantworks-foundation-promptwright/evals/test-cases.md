...
## Case 44 — Confirm shared understanding: present for a non-trivial agent build, absent for a fully-specified one *(executed 2026-09-10, 6/6 — two independent blind builds, judged cold — see evals/RESULTS.md; one doctrine finding on the checkpoint's phrasing found and filed)*
